        ...
        <defs>
          {pathData.map((_, i) => (
            <linearGradient
              ...
              y2="100%"
            >
              <stop offset="0%" stopColor="#0080e0" stopOpacity="0" />
              <stop offset="20%" stopColor="#0080e0" stopOpacity="1" />
              <stop offset="50%" stopColor="#38a5f5" stopOpacity="1" />
              <stop offset="80%" stopColor="#72c8ff" stopOpacity="1" />
              <stop offset="100%" stopColor="#72c8ff" stopOpacity="0" />
            </linearGradient>
          ))}
        </defs>
      </svg>
